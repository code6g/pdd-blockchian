 ...
 * @date 2019-12-16 
 */
public class Peerinfo extends BaseEntity
{
    private static final long serialVersionUID = 1L;
            ...
            @Excel(name = "区块号码")
            private String qkhm;        //  区块号码
            @Excel(name = "是否连接")
            private String sflj;        //  是否连接
            @Excel(name = "备注项00")
       ...
       public String getQkhm() //区块号码
       {
           return qkhm;
       }
       public void setQkhm(String qkhm) //区块号码
       {
           this.qkhm = qkhm;
       }	
       public String getSflj() //是否连接
       {
           return sflj;
       }
       public void setSflj(String sflj) //是否连接
       {
           this.sflj = sflj;
       }	
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("qkhm", getQkhm()) //区块号码
            .append("sflj", getSflj()) //是否连接
