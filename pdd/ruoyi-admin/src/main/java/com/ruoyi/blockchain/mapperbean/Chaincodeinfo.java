...
/**
 * 链码（智能合约）bean: chaincodeinfo
 * 
 * @author 牛哥 
 * @date 2019-12-16 
 */
public class Chaincodeinfo extends BaseEntity
{
    private static final long serialVersionUID = 1L;

            @Excel(name = "链码名称")
            private String ccmc;        //  链码名称
            @Excel(name = "链码编号")
            private String ccbh;        //  链码编号
            @Excel(name = "链码版本")
            private String ccbb;        //  链码版本
            @Excel(name = "链码路径")
            private String cclj;        //  链码路径
            @Excel(name = "链码输入")
            private String ccsr;        //  链码输入
            @Excel(name = "链码说明")
            private String ccsm;        //  链码说明
            @Excel(name = "通道名称")
       ...
       public String getCcmc() //链码名称
       {
           return ccmc;
       }
       public void setCcmc(String ccmc) //链码名称
       {
           this.ccmc = ccmc;
       }	
       public String getCcbh() //链码编号
       {
           return ccbh;
       }
       public void setCcbh(String ccbh) //链码编号
       {
           this.ccbh = ccbh;
       }	
       public String getCcbb() //链码版本
       {
           return ccbb;
       }
       public void setCcbb(String ccbb) //链码版本
       {
           this.ccbb = ccbb;
       }	
       public String getCclj() //链码路径
       {
           return cclj;
       }
       public void setCclj(String cclj) //链码路径
       {
           this.cclj = cclj;
       }	
       public String getCcsr() //链码输入
       {
           return ccsr;
       }
       public void setCcsr(String ccsr) //链码输入
       {
           this.ccsr = ccsr;
       }	
       public String getCcsm() //链码说明
       {
           return ccsm;
       }
       public void setCcsm(String ccsm) //链码说明
       {
           this.ccsm = ccsm;
       }	
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("ccmc", getCcmc()) //链码名称
            .append("ccbh", getCcbh()) //链码编号
            .append("ccbb", getCcbb()) //链码版本
            .append("cclj", getCclj()) //链码路径
            .append("ccsr", getCcsr()) //链码输入
            .append("ccsm", getCcsm()) //链码说明
