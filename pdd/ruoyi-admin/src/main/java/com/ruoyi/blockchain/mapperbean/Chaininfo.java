 ...
 * @date 2019-12-16 
 */
public class Chaininfo extends BaseEntity
{
    private static final long serialVersionUID = 1L;

            @Excel(name = "链编码")
            private String lid;        //  链编码
            @Excel(name = "链高度")
            private String lgd;        //  链高度
            @Excel(name = "当前块哈希")
            private String dqhx;        //  当前块哈希
            @Excel(name = "前块哈希")
            private String qkhx;        //  前块哈希
            @Excel(name = "存储初始化")
            private String cccs;        //  存储初始化
            @Excel(name = "未知字段")
            private String wzzd;        //  未知字段
            @Excel(name = "存储大小")
            private String ccdx;        //  存储大小
            @Excel(name = "存储哈希")
            private String cchx;        //  存储哈希
            @Excel(name = "备注项00")
       ...
       public String getLid() //链编码
       {
           return lid;
       }
       public void setLid(String lid) //链编码
       {
           this.lid = lid;
       }	
       public String getLgd() //链高度
       {
           return lgd;
       }
       public void setLgd(String lgd) //链高度
       {
           this.lgd = lgd;
       }	
       public String getDqhx() //当前块哈希
       {
           return dqhx;
       }
       public void setDqhx(String dqhx) //当前块哈希
       {
           this.dqhx = dqhx;
       }	
       public String getQkhx() //前块哈希
       {
           return qkhx;
       }
       public void setQkhx(String qkhx) //前块哈希
       {
           this.qkhx = qkhx;
       }	
       public String getCccs() //存储初始化
       {
           return cccs;
       }
       public void setCccs(String cccs) //存储初始化
       {
           this.cccs = cccs;
       }	
       public String getWzzd() //未知字段
       {
           return wzzd;
       }
       public void setWzzd(String wzzd) //未知字段
       {
           this.wzzd = wzzd;
       }	
       public String getCcdx() //存储大小
       {
           return ccdx;
       }
       public void setCcdx(String ccdx) //存储大小
       {
           this.ccdx = ccdx;
       }	
       public String getCchx() //存储哈希
       {
           return cchx;
       }
       public void setCchx(String cchx) //存储哈希
       {
           this.cchx = cchx;
       }	
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("lid", getLid()) //链编码
            .append("lgd", getLgd()) //链高度
            .append("dqhx", getDqhx()) //当前块哈希
            .append("qkhx", getQkhx()) //前块哈希
            .append("cccs", getCccs()) //存储初始化
            .append("wzzd", getWzzd()) //未知字段
            .append("ccdx", getCcdx()) //存储大小
            .append("cchx", getCchx()) //存储哈希
