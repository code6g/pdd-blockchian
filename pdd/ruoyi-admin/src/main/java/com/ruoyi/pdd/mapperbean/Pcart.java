 ...
 * @date 2019-12-16 
 */
public class Pcart extends BaseEntity
{
    private static final long serialVersionUID = 1L;

            @Excel(name = "购物车编码")
            private String gwid;        //  购物车编码
            @Excel(name = "会员编码")
       ...
       public String getGwid() //购物车编码
       {
           return gwid;
       }
       public void setGwid(String gwid) //购物车编码
       {
           this.gwid = gwid;
       }	
