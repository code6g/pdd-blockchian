...
//			}
			...
			Thread.sleep(10000);
			String[] args1 = {"a"};
			Collection<ProposalResponse>  responses1Query = channelClient.queryByChainCode("mycc", "query", args1);
			...
			Thread.sleep(10000);
			String[] argsb = {"b"};
			Collection<ProposalResponse>  responses1Queryb = channelClient.queryByChainCode("mycc", "query", argsb);
