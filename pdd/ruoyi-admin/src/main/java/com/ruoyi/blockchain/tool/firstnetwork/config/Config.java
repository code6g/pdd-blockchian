package com.ruoyi.blockchain.tool.firstnetwork.config;
...
public class Config {
	...
	public static final String ORG2_USR_BASE_PATH =File.separator+"data"+File.separator+ "crypto-config"
			+ File.separator + "peerOrganizations" + File.separator
