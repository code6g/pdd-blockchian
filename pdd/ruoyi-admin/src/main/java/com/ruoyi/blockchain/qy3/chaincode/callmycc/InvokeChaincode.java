 ...
 */ 
package com.ruoyi.blockchain.qy3.chaincode.callmycc;
...
public class InvokeChaincode {
	...
	public static void main(String args[]) {
		try {
			...
			Loglw.print("call chain code  args","invoke,a,b,3");
			...
			tm2.put("method", "c".getBytes(UTF_8));
			...
			for (ProposalResponse res: responses) {
				...
				Loglw.print("Response ","Invoked chaincode on "+Config.CHAINCODE_1_NAME + ".Result Status - " + status);

				Logger.getLogger(InvokeChaincode.class.getName()).log(Level.INFO,"Invoked chaincode on "+Config.CHAINCODE_1_NAME + ". Result Status - " + status);
			}
